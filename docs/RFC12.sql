...
SELECT SEL1.NUMEROSEMANA, SEL1.TOTALDIASUSADA, OFE2.ID,OFE2.DESCUENTO,OFE2.DIASACTIVA,OFE2.FECHAFIN,OFE2.FECHAINICIO,OFE2.TIEMPOCONTRATO,OFE2.ACTIVA,OFE2.DISPONIBLE
FROM 
