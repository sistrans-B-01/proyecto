...
public class SQLOferta 
{
	 ...
	 */
	public long adicionarOferta (PersistenceManager pm, long ido, int des, int dias, int usada, Timestamp fin, Timestamp lle, String tiem) 
	{
        Query q = pm.newQuery(SQL, "INSERT INTO " + pp.darTablaOferta () + "(id, descuento, diasactiva, diasusada, fechafin, fechainicio, tiempocontrato) values (?, ?, ?, ?, ?, ?, ?)");
        q.setParameters(ido, des, dias, usada, fin, lle, tiem);
